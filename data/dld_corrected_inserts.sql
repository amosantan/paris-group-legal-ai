-- DLD Documents - Corrected Insert Statements
-- These statements let the database auto-generate IDs
...
from the date of repossessi... [content truncated for database storage]',
  'Dubai Real Estate Law',

...
export async function generateConsultationPDF(report: ConsultationReport): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    // Header with Paris Group branding
    doc
      .fontSize(20)
      .fillColor("#1e40af")
      .text("Paris Group Legal Consultant", { align: "center" });
    doc
      .fontSize(10)
      .fillColor("#666")
    ...
    doc.text(
      "This consultation report is generated by an AI legal assistant and should not be considered as formal legal advice. " +
        ...
        "For critical legal matters, please consult with a licensed legal professional at Paris Group Legal Consultant.",
      { align: "justify" }
    );
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.text(
      "This contract review is generated by an AI legal assistant and should not be considered as formal legal advice. " +
        ...
        "For critical contract matters, please consult with a licensed legal professional at Paris Group Legal Consultant for comprehensive review.",
      { align: "justify" }
    );
